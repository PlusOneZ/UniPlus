...
public class RequestUtil {
    ...
    public static void main(String[] args) throws Exception{
        // 创建云信id
        createAccid("https://api.netease.im/nimserver/user/create.action","001", "测试");
        // 发送普通消息
     ...
     * @throws 
     */
    public static void createAccid(String url, String accid, String name) throws IOException {
